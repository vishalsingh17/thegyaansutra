...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="hidden lg:block sticky top-0 left-0 z-50 w-full py-3 backdrop-blur-lg bg-transparent">
        <div className="container px-4 text-sm mx-auto relative">
          <div className="flex justify-between items-center">
            ...
            <ul className="hidden lg:flex space-x-12 ml-14 cursor-pointer font-jakarta font-bold">
              <li className="text-[#161637] hover:text-[#4d4dff] font-semibold my-auto"><a href="/">HOME</a></li>
              <li
              ...
              <li className="text-[#161637] hover:text-[#4d4dff] font-semibold my-auto" onClick={() => navigateToSection("outcomes")}>OUTCOMES</li>
              <li className="text-[#161637] hover:text-[#4d4dff] font-semibold my-auto" onClick={() => navigateToSection("curriculum")}>
                CURRICULUM
              </li>
            </ul>
      ...
      <nav className="lg:hidden relative top-0 left-0 z-50 w-full py-3 backdrop-blur-lg bg-transparent">
              ...
              {!coursesOpen ? (
                <div className="relative flex flex-col justify-center items-center w-full lg:hidden">
                  <ul className="py-2 cursor-pointer text-lg text-center">
                    <li className="text-[#4d4dff] font-semibold p-4"><a href="/">HOME</a></li>
                    <li
                    ...
                    <li className="text-[#4d4dff] font-semibold p-4" onClick={() => navigateToSection("outcomes")}>OUTCOMES</li>
                    <li className="text-[#4d4dff] font-semibold p-4" onClick={() => navigateToSection("curriculum")}>CURRICULUM</li>
                  </ul>
                  {!user && (
                    <a href="/Login">
